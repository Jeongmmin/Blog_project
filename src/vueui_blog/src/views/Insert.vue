...
<div class ="row"> 
            ...
            <div class = "col-md-6 mx-auto text-left">
                ...
                <div class="form-group">
                    ...
                    <textarea name="contents" class= "form-control" id="contents" v-model = "contents" cols="30" rows="10" placeholder="내용을 입력하세요"></textarea>
                </div>

                <div class="row">
                    <div class="col-md-6">
                        <button type = "button" class = "btn btn-outline-warning btn-block" @click = "boardInsert"> 글 등록 </button>
                    </div>
                    <div class="col-md-6">
